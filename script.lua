...
local FRIEND_SOCIAL_DISTANCE = 4
local BEST_FRIEND_SOCIAL_DISTANCE = 4
local CRUSH_SOCIAL_DISTANCE = 4
local RELATIONSHIP_TALK_MIN_TIME = 2.5
local RELATIONSHIP_TALK_MAX_TIME = 4.5
...
local DIALOGUE_MIN_TIME = 8
local DIALOGUE_MAX_TIME = 18
...
local PERSONALITY_PROFILES = {
	...
	Friendly = {
		...
		CrushChats = {
			...
			"You're becoming someone very special to me.",
			"I think about you more than I expected.",
			"I get nervous when you're this close.",
	...
	Funny = {
		...
		CrushChats = {
			"Uh oh. I think I caught feelings. That's inconvenient.",
			"Why does seeing you make my brain stop working?",
			"I may have a tiny crush. Tiny. Probably.",
			"Don't tell anyone, but you're kind of my favorite.",
			"Okay, fine. You're cute. Happy now?",
			"My heart has terrible comedic timing."
		}
	},
	...
	Curious = {
		...
		CrushChats = {
			"I've been wondering why I feel different around you.",
			"I think I'm starting to understand what a crush feels like.",
			"Why do I keep thinking about you?",
			"You're... unusually interesting to me.",
	...
	Dominant = {
		...
		CrushChats = {
			"You've become more important to me than I expected.",
			"I don't usually get distracted. You are an exception.",
			"Stay close. I like having you here.",
			"I think I've got feelings for you.",
			"Don't make me admit how much I care.",
			"You're the one person I keep looking for."
		}
	},
	...
	Shy = {
		...
		CrushChats = {
			...
			"I get nervous whenever you're close.",
			"I've been thinking about you a lot.",
			"You're really important to me.",
			"I think I might have a crush on you...",
			"Please don't laugh, but I really like you."
		}
	},
	...
	Serious = {
		...
		CrushChats = {
			"I have considered it carefully. I care about you deeply.",
			"My feelings for you are becoming difficult to ignore.",
			"I find myself looking forward to seeing you.",
			"You have become unusually important to me.",
			"I believe this is more than friendship.",
	...
	Brave = {
		...
		CrushChats = {
			"Okay, I'll admit it. I like you.",
			"I've faced plenty of scary things. This is somehow harder.",
			"You're someone I'd choose every time.",
	...
	Sarcastic = {
		...
		CrushChats = {
			"Great. I have a crush. Fantastic.",
			"As if I needed another reason to think about you.",
			"Don't get smug. I like you, okay?",
			"This is embarrassing. You're important to me.",
			"Apparently my heart has terrible judgment.",
	...
	Tsundere = {
		...
		CrushChats = {
			...
			"You're... really important to me, okay?!",
			"I like you. There. Happy?!",
...
local RELATIONSHIP_STAGES = {
	...
	},
	{
		Name = "Crush",
		Min = 95,
		Color = Color3.fromRGB(255, 120, 165)
	}
}
...
local function getRelationshipStage(value)
	...
	if crushActive then
		return RELATIONSHIP_STAGES[#RELATIONSHIP_STAGES]
	end
...
local relationshipTalking = false
local relationshipTalkUntil = 0
...
-- Social interaction: approach first, talk once, wait 3-5 seconds, wander again.
local socialTalkActive = false
local socialTalkUntil = 0
...
modeLayout.CellSize = UDim2.new(0.5, -4, 1, 0)
...
friendshipToggle.Activated:Connect(function()
	...
	-- Once an AI has been created, Friendship Mode is locked.
	-- START OVER is required to change it.
...
local function getRelationshipTalkDistance()
	local stage = getRelationshipStage(friendshipValue)

	if stage.Name == "Stranger" then
		return STRANGER_SOCIAL_DISTANCE
	elseif stage.Name == "Acquaintance" then
		return ACQUAINTANCE_SOCIAL_DISTANCE
	elseif stage.Name == "Friend" then
		return FRIEND_SOCIAL_DISTANCE
	elseif stage.Name == "Best Friend" then
		return BEST_FRIEND_SOCIAL_DISTANCE
	end

	return CRUSH_SOCIAL_DISTANCE
end

local function beginRelationshipTalk()
	if not friendshipEnabled then
		return
	end

	relationshipTalking = true
	relationshipTalkUntil = os.clock() + random:NextNumber(
		RELATIONSHIP_TALK_MIN_TIME,
		RELATIONSHIP_TALK_MAX_TIME
	)
...
local function say(text)
	...
	-- IMPORTANT:
	-- A relationship bubble must NOT freeze the NPC while it is
	-- still approaching the player. The old version called
	-- beginRelationshipTalk() for the "Oh. Hey." notice line,
	-- which immediately stopped the approach.
	--
	-- Only start the normal relationship-talk state after the NPC
	-- has actually arrived (approachPhase/socialApproachActive are
	-- both false at that point).
	if friendshipEnabled
		and hasNoticedPlayer
		and not approachPhase
		and not socialApproachActive then
		beginRelationshipTalk()
	end
...
local function getRelationshipChats()
	...
	if stage.Name == "Crush"
		and currentProfile.CrushChats then

		return currentProfile.CrushChats

	elseif stage.Name == "Best Friend"
